    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-primary-dark/40 backdrop-blur-sm transition-all">
            ...
            <div className="bg-bone-light/90 backdrop-blur-2xl rounded-3xl shadow-[0_0_30px_rgba(0,0,0,0.2)] border border-white/50 w-full max-w-md p-6 relative animate-in fade-in zoom-in duration-200">
                ...
                <button
                    onClick={onClose}
                    className="absolute top-4 right-4 p-2 text-font-primary-dark/50 hover:text-font-primary-dark hover:bg-bone-light/50 rounded-full transition-colors"
                >
                    <X className="w-5 h-5" />
                </button>
                ...
                <div className="flex flex-col items-center text-center mt-2">
                    ...
                    <h3 className="text-xl font-bold text-font-primary-dark mb-2">{title}</h3>
                    <p className="text-font-primary-dark/70 mb-8">{message}</p>

                    {/* btns actions */}
                    <div className="flex items-center gap-4 w-full">
                        <button
                            onClick={onClose}
                            className="flex-1 py-3 px-4 rounded-xl font-medium text-font-primary-dark bg-bone-light/50 border border-primary-dark/10 hover:bg-bone-light transition-colors"
                        >
                            Annuler
                        </button>
                        <button
