...
export default function N8nSyncCard() {
  ...
  return (
    <section className="mb-10">
      ...
      <div className="bg-white/70 backdrop-blur-md p-6 rounded-3xl shadow-[0_0_15px_rgba(0,0,0,0.05)] border border-white/50 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <p className="font-medium text-primary-dark">Pipeline N8N - Source : WeLoveDevs</p>
