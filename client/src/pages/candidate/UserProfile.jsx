                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="relative">
                                    <input type="tel" name="phone" placeholder="06 06 06 06 06" value={profileData.phone} onChange={handleChange} className="w-full pl-10 pr-4 py-2.5 bg-bone-light/50 border border-white/60 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/50 text-font-primary-dark transition-all" />
                                    <Phone className="w-5 h-5 text-font-primary-dark/40 absolute left-3 top-1/2 -translate-y-1/2" />
                                </div>
                                <div className="relative md:col-span-2">
                                    <input type="text" name="location" placeholder="Localisation" value={profileData.location} onChange={handleChange} className="w-full pl-10 pr-4 py-2.5 bg-bone-light/50 border border-white/60 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/50 text-font-primary-dark transition-all" />
                                    <MapPin className="w-5 h-5 text-font-primary-dark/40 absolute left-3 top-1/2 -translate-y-1/2" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4 pt-2">
                            <h2 className="text-lg font-semibold text-font-primary-dark">Liens professionnels</h2>

                            <div className="relative">
                                <input type="text" name="github" placeholder="Lien de votre GitHub" value={profileData.github} onChange={handleChange} className="w-full pl-10 pr-4 py-2.5 bg-bone-light/50 border border-white/60 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/50 text-font-primary-dark transition-all" />
                                <Cat className="w-5 h-5 text-font-primary-dark/40 absolute left-3 top-1/2 -translate-y-1/2" />
                            </div>

                            <div className="relative">
                                <input type="text" name="portfolio" placeholder="Lien vers votre Portfolio / Projets" value={profileData.portfolio} onChange={handleChange} className="w-full pl-10 pr-4 py-2.5 bg-bone-light/50 border border-white/60 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/50 text-font-primary-dark transition-all" />
                                <Globe className="w-5 h-5 text-font-primary-dark/40 absolute left-3 top-1/2 -translate-y-1/2" />
                            </div>
                        </div>
                            ...
                            <div className="flex gap-3">
                                <button
                                    ...
                                    className={`flex-1 px-4 py-2.5 rounded-xl font-medium border transition-colors ${handedness === "left"
                                        ...
                                        : "bg-bone-light/50 dark:bg-bone-light/50 border-white/60 dark:border-white/10 text-font-primary-dark hover:bg-primary/10"
                                        }`}
                                >
                                    Gaucher
                                </button>
                        ...
                        <div className="space-y-4 pt-6 border-t border-primary-dark/10">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                ...
                                <button type="button" onClick={disableNotifications} className="flex-1 flex justify-center items-center gap-2 px-4 py-3 bg-bone-light/60 border border-red-200 text-red-500 font-medium rounded-xl hover:bg-red-50 transition-colors">
                                    <BellOff className="w-5 h-5" />
                                    Désactivation des notifications
                                </button>
                                <button type="button" onClick={requestAccountDeletion} className="flex-1 flex justify-center items-center gap-2 px-4 py-3 bg-bone-100/80 border border-red-200 text-red-600 font-medium rounded-xl hover:bg-red-200 transition-colors">
