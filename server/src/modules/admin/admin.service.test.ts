...
describe("AdminService - getAllMembers", () => {
    ...
    describe("Cas d'erreurs", () => {
        it("devrait lancer une erreur si la requête échoue", async () => {
            ...
            await expect(adminService.getAllMembers()).rejects.toThrow(errorMessage);
        ...
        it("devrait libérer la connexion même si la récupération de connexion échoue", async () => {
            ...
            await expect(adminService.getAllMembers()).rejects.toThrow("Connexion impossible");
        });
        ...
        it("devrait lancer NO_MEMBERS_FOUND si seul le membre courant est présent", async () => {
            ...
            await expect(adminService.getAllMembers(1)).rejects.toThrow("NO_MEMBERS_FOUND");
            expect(mockConnection.release).toHaveBeenCalled();
        });
    });
